    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="container mx-auto px-4 flex-grow">
        <div className="grid grid-cols-1 lg:grid-cols-12 lg:gap-12">
            ...
            <main className="lg:col-span-7 xl:col-span-8 space-y-8 pt-10 pb-16">
            ...
            <aside className="hidden lg:block lg:col-span-5 xl:col-span-4 sticky top-24 self-start pt-10">
                <OrderSummary />
            </aside>
        </div>
      </div>
